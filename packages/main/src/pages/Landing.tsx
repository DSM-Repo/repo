...
import { Modal } from "@/router/Layout/components";
        ...
        <>
            ...
            <div className="py-[172px] px-[40px] flex flex-col justify-center items-center gap-[80px]">
                ...
                <div className="w-screen h-2/5 py-5 flex flex-col justify-center items-center gap-4 font-black text-[48px] text-white">
                    ...
                    <p className="font-extrabold text-[36px] mb-[64px]">손쉽게 작성하는 이력서</p>
                    <div className="flex">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="font-normal text-[16px] text-[#D1D1D1]">
                                <p>이력서 정보들의 형식에 맞게, 다양한 종류의 입력을 제공해 드리고 있어요.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="py-5 flex justify-center items-center text-white">
                    <div className="flex flex-col mr-3">
                        <Image8 className="mb-[20px]" />
                        <p className="font-extrabold text-[36px] mb-[64px]">실시간 결과 확인</p>
                        <Image5 />
                        <p className="font-normal text-[20px] text-[#D1D1D1] mt-4">실시간으로 반영되는 모습을 확인하며 작업할 수 있어요.</p>
                    </div>
                    <Image6 />
                </div>
                ...
                <div className="py-5 flex justify-center items-center text-white">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="font-normal text-[20px] text-[#D1D1D1] mt-6">이전 기수 선배분들의 이력서를 도서관에서 참고해 볼 수 있어요.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full h-fit flex justify-center border border-[#333333]">
                <div className="w-4/5 h-fit py-[48px] gap-[20px] font-normal text-[#D1D1D1] text-[14px]">
                    ...
                    <div>
                        ...
                        <p>교무실 : 042-866-8822 | Fax : 042-867-9900 | 행정실 : 042-866-8885 | Fax : 042-863-4308</p>
                    </div>
