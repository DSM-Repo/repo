    ...
    <>
      ...
      <div className="py-[172px] px-[40px] flex flex-col justify-center w-full items-center gap-[80px]">
        ...
        <div className="w-full h-2/5 flex flex-col justify-center items-center gap-4 font-black text-[48px] text-white">
          ...
          <div
            className="w-36 h-11 border border-[#6D6D6D] flex justify-center items-center font-normal text-[16px] rounded-[22px] mt-6 mb-16 cursor-pointer bg-[#222222] hover:bg-[#6D6D6D]"
            onClick={() => setIsModalOpen(true)}
          >
            Repo 사용하기
          </div>
      ...
      <div className="bg-custom-image flex justify-between items-center w-full bg-gray-900 font-normal text-[16px] text-white">
        ...
        <div className="flex flex-col py-20 items-center">
          ...
          <div
            className="w-36 h-11 border border-[#6D6D6D] flex justify-center items-center rounded-[22px] mt-6 cursor-pointer bg-[#222222] hover:bg-[#6D6D6D]"
            onClick={() => setIsModalOpen(true)}
          >
            Repo 사용하기
          </div>
